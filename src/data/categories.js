import cakeLayer from '../assets/ケーキ-layer.avif';
...
import petitMousseCafe from '../assets/プ2-ムースショコラキャフェ.avif';
import petitShortcake from '../assets/プ3-ショートケーキ.avif';
import petitRareCheesecake from '../assets/プ4-レアチーズケーキ.avif';
import petitCaramelMillefeuille from '../assets/プ5-キャラメルミルフィーユ.avif';
import petitApplePie from '../assets/プ6-アップルパイ.avif';
import petitCreamPuff from '../assets/プ7-シュークリーム.avif';
import petitPistachio from '../assets/プ8-フレーズピスターシュ.avif';
import petitJean from '../assets/プ9-ジャン.avif';
import petitCheesecake from '../assets/プ10-チーズケーキ.avif';
import petitChocolat from '../assets/プ11-ショコララーム.avif';
import petitEggRoll from '../assets/プ12-たまごロール.avif';
import petitCustardPudding from '../assets/プ13-カスタードプリン.avif';
import petitRusk from '../assets/プ14-ラスクシュー.avif';
import petit58roll from '../assets/プ15-ゴーパチ５８ロール.avif';
import petitMontBlanc from '../assets/プ16-モンブラン.avif';
import petitMarbleCake from '../assets/プ17-マーブル.avif';
import petitCoffeeJelly from '../assets/プ18-コーヒーゼリー.avif';
import petitRawChocolateRoll from '../assets/プ19-生チョコロール.avif';
import petitCremeBrulee from '../assets/プ20-クレームブリュレ.avif';
import petitSmoothPudding from '../assets/プ21-なめらかプリン.avif';
import petitPuddingTorte from '../assets/プ22-プリントルテ.avif';
import petitChocolateRaspberry from '../assets/プ23-ショコラと木苺のケーキ.avif';

import macaronImgLayer from '../assets/マカロン-layer.avif';
import macaronPassionFruit from '../assets/マカロン1-マカロンパッション.avif';
import macaronRaspberry from '../assets/マカロン2-マカロンフランボワーズ.avif';
import macaronValencia from '../assets/マカロン3-マカロンバレンシア.avif';
import macaronCafe from '../assets/マカロン4-マカロンカフェ.avif';
import macaronPistachio from '../assets/マカロン5-マカロンピスタチオ.avif';
import macaronVanilla from '../assets/マカロン6-マカロンバニラ.avif';
import macaronChocolate from '../assets/マカロン7-マカロンショコラ.avif';

import yakugashiLayer from '../assets/焼菓子-layer.avif';
import yakugashiFlorentine from '../assets/焼菓子1-フロランタン.avif';
import yakugashiPlain from '../assets/焼菓子2-プレーン.avif';
import yakugashiPistachio from '../assets/焼菓子3-ピスタチオ.avif';
import yakugashiStangen from '../assets/焼菓子4-シュタンゲン.avif';
import yakugashiMarble from '../assets/焼菓子5-マーブル.avif';
import yakugashiGalette from '../assets/焼菓子6-ガレット.avif';
import yakugashiCinnamon from '../assets/焼菓子7-シナモン.avif';
import yakugashiChocolateChip from '../assets/焼菓子8-チョコチップ.avif';
import yakugashiCoconut from '../assets/焼菓子9-ココナッツ.avif';
import yakugashiColombo from '../assets/焼菓子10-コロンボ.avif';
import yakugashiKurumi from '../assets/焼菓子11-くるみ.avif';
import yakugashiAlmond from '../assets/焼菓子12-アーモンド.avif';
import yakugashiMacadamia from '../assets/焼菓子13-マカダミア.avif';
import yakugashiNuss from '../assets/焼菓子14-ヌス.avif';

import hanNGashiCapaImgLayer from '../assets/半生菓子-layer.avif';
import hanNGashi1960s from '../assets/半生菓子1-昭和４０年代マドレーヌ.avif';
import hanNGashiFinancier from '../assets/半生菓子2-フィナンシェ.avif';
import hanNGashiChocolate  from '../assets/半生菓子3-プライムショコラフィナンシェ.avif';
import hanNGashiPrimeFinancier from '../assets/半生菓子4-プライムフィナンシェ.avif';
import hanNGashiCochillage from '../assets/半生菓子5-コキラージュ.avif';
